#include "RaibertPositionController.h"
...
RaibertPositionController::RaibertPositionController(const char *f, const char * actuatorNames[], const char * jointNames[], const char * endeffectorNames[]) : ModelController(f) {
...
RaibertPositionController::~RaibertPositionController() {
	free(this);
}

void RaibertPositionController::step() {
...
void RaibertPositionController::keyboardCallback(GLFWwindow*, int key, int, int act, int) {
